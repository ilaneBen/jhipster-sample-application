...
export const MagasinDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.magasin.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.magasin.delete.question" interpolate={{ id: magasinEntity.id }}>
