...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './magasin.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAGASIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_MAGASIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MAGASIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MAGASIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MAGASIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MAGASIN actions', async () => {
      const expectedActions = [
        {
