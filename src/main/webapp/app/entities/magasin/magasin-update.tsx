  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.magasin.home.createOrEditLabel" data-cy="MagasinCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationApp.magasin.home.createOrEditLabel">Create or edit a Magasin</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.magasin.nom')}
                id="magasin-nom"
                name="nom"
                data-cy="nom"
                type="text"
