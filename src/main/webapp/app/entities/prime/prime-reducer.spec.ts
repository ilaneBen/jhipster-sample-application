...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './prime.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIME_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRIME actions', async () => {
      const expectedActions = [
        {
