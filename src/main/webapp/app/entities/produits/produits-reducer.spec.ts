...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './produits.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUITS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUITS actions', async () => {
      const expectedActions = [
        {
