...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vendeur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VENDEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_VENDEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VENDEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VENDEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VENDEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VENDEUR actions', async () => {
      const expectedActions = [
        {
