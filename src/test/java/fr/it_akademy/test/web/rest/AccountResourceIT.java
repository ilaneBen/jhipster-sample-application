...
import fr.it_akademy.test.config.Constants;
import fr.it_akademy.test.domain.PersistentToken;
import fr.it_akademy.test.domain.User;
import fr.it_akademy.test.repository.AuthorityRepository;
import fr.it_akademy.test.repository.PersistentTokenRepository;
import fr.it_akademy.test.repository.UserRepository;
import fr.it_akademy.test.security.AuthoritiesConstants;
import fr.it_akademy.test.service.UserService;
import fr.it_akademy.test.service.dto.AdminUserDTO;
import fr.it_akademy.test.service.dto.PasswordChangeDTO;
import fr.it_akademy.test.web.rest.vm.KeyAndPasswordVM;
import fr.it_akademy.test.web.rest.vm.ManagedUserVM;
